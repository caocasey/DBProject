...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <!-- Custom CSS -->
        <link rel="stylesheet" href="<?php echo e(URL::asset('css/sb-admin.css')); ?>" />
        <!-- Morris Charts CSS -->
        <link rel="stylesheet" href="<?php echo e(URL::asset('css/plugins/morris.css')); ?>" />
        <!-- Custom Fonts -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div>Welcome <span id="uname"><small><?php echo e(Session::get('uname')); ?></small></span></p><div>
                            </h1>
                        </div>
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-green">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="middle"><?php echo e($trackNumber); ?> total</div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="middle"><?php echo e($plNumber); ?> total</div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="middle"><?php echo e($albumNumber); ?> total</div>
